...
class Countdown {
    ...
    private let target = DateComponents(calendar: NSCalendar.current, timeZone: TimeZone(abbreviation: "EDT"),
                                        era: nil, year: 2018, month: 10, day: 7, hour: 18, minute: 15, second: 0,
                                        nanosecond: 0, weekday: nil, weekdayOrdinal: nil, quarter: nil,
